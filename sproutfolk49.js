...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    let bubblerm = new Image()
    bubblerm.src = "bubblerm.png"
    let bubblery = new Image()
    bubblery.src = "bubblery.png"
    let bubblerc = new Image()
    ...
    class Throbert {
        ...
        draw() {
            ...
            if (this.first == 0) {
                ...
                for (let t = 0; t < 30; t++) {
                    let plug = new Boubyelega(2560 + ((Math.random() - .5) * 5120), 2560 + ((Math.random() - .5) * 5120), ['red', "magenta", "orange"])
                    plug.body.x *= 2
                    plug.body.y *= 2
                    this.enemies.push(plug)
                }
